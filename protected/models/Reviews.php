...
class Reviews extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('senderId, receiverId, review, rating, reviewType, sourceId, createdDate', 'required'),
			...
			array('reviewId, senderId, receiverId, review, rating, reviewType, sourceId, createdDate', 'safe', 'on'=>'search'),
		);
	}

		...
		<ul style="padding: 0;" class="profile-vertical-tab-container nav nav-tabs col-xs-12 col-sm-3 col-md-3 col-lg-3">
					  <li class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
							<div class="profile-icon-cnt col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
								<div class="profile-page-profile-icon" style="background:url('<?php if(!empty($model->userImage)) {  echo Yii::app()->createAbsoluteUrl('user/resized/150/'.$model->userImage); }else{ echo Yii::app()->createAbsoluteUrl('user/resized/150/default/'.Myclass::getDefaultUser()); }?>') no-repeat;">
							...
							<div class="profile-details col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
								...
								<div class="profile-country-name">India</div>
					  ...
					  <li class="active col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
						<?php echo CHtml::link(Yii::t('app','Promotions'),Yii::app()->createAbsoluteUrl('user/promotions',array('id'=>Myclass::safe_b64encode($user->userId.'-'.rand(0,999)))),array('class' => ''.$lactive));  ?>
					  </li>
					  <li class=" col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
						<?php echo CHtml::link(Yii::t('app','My Exchange'),Yii::app()->createAbsoluteUrl('item/exchanges?type=incoming'),array('class' => ' '.$lactive));  ?>
					  </li>
					  <li class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
							...
							<div class="promotion-content col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding" id="promotion-content">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
									<ul class="recent-activities-tab nav nav-tabs">
									  ...
									  <li><?php echo CHtml::link(Yii::t('app','Advertisement'),Yii::app()->createAbsoluteUrl('user/advertisePromotions',array('id'=>Myclass::safe_b64encode($user->userId.'-'.rand(0,999)))));  ?></li>
									...
									<?php } else { ?>
										<div class="modal-dialog modal-dialog-width">
													<div class="col-xs-8 col-sm-12 col-md-12 col-lg-12 no-hor-padding" style="margin-bottom:100px;">
														<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
															<div class="payment-decline-status-info-txt" style="margin: 8% auto 0;"><img src="<?php echo Yii::app()->createAbsoluteUrl("/images/empty-tap.jpg");?>"></br><span class="payment-red">Sorry...</span> Yet no product are here.</div>
														</div>
													</div>
												</div>
									<?php }  ?>

										...
										<div class="modal-dialog modal-dialog-width">
											<div class="col-xs-8 col-sm-12 col-md-12 col-lg-12 no-hor-padding" style="margin-bottom:100px;">
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
													<div class="payment-decline-status-info-txt" style="margin: 8% auto 0;"><img src="<?php echo Yii::app()->createAbsoluteUrl("/images/empty-tap.jpg");?>"></br><span class="payment-red"><?php echo Yii::t('app','Sorry...'); ?></span> <?php echo Yii::t('app','You have not added any stuff.'); ?></div>
													<div class="col-lg-12 no-hor-padding"><a class="payment-promote-btn login-btn" href="<?php echo Yii::app()->createAbsoluteUrl('/products/create'); ?>"><?php echo Yii::t('app','Go to add your stuff'); ?></a></div>
												</div>
											</div>
										</div>
...
max-height: 508px;
							...
							<div class="load-more-cnt col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
									<div class="qMart-loader" style="width: 60px;"><div class="cssload-loader"></div></div>
						...
						<?php } }else{ ?>
								<?php if(count($products) != 0){ ?>
											...
											<div class="col-xs-8 col-sm-12 col-md-12 col-lg-12 no-hor-padding" style="margin-bottom:100px;">
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
													<div class="payment-decline-status-info-txt" style="margin: 8% auto 0;"><img src="<?php echo Yii::app()->createAbsoluteUrl("/images/empty-tap.jpg");?>"></br><span class="payment-red"><?php echo Yii::t('app','Sorry...'); ?></span> <?php echo Yii::t('app','User is not added any stuff.'); ?></div>
												</div>
											</div>
											</div>
										<?php } } ?>
								...
								<div id="liked" class="tab-pane fade in active">
									<div class="center profile-listing-product-cnt col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
										<?php if(Yii::app()->user->id == $user->userId) { ?>
											...
											<div class="col-xs-8 col-sm-12 col-md-12 col-lg-12 no-hor-padding" style="margin-bottom:100px;">
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
													<div class="payment-decline-status-info-txt" style="margin: 8% auto 0;"><img src="<?php echo Yii::app()->createAbsoluteUrl("/images/empty-tap.jpg");?>"></br><span class="payment-red"><?php echo Yii::t('app','Sorry...'); ?></span> <?php echo Yii::t('app','You have not liked any products.'); ?></div
													<div class="col-lg-12 no-hor-padding"><a class="payment-promote-btn login-btn" href="<?php echo Yii::app()->createAbsoluteUrl('/'); ?>">Go to home<?php echo Yii::t('app','Home'); ?></a></div>
												</div>
											</div>
											</div>
											<?php }else{ ?>
										...
										<?php }else{ ?>
											...
											<?php }else{ ?>
												<div class="modal-dialog modal-dialog-width">
													<div class="col-xs-8 col-sm-12 col-md-12 col-lg-12 no-hor-padding" style="margin-bottom:100px;">
														<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
															<div class="payment-decline-status-info-txt" style="margin: 8% auto 0;"><img src="<?php echo Yii::app()->createAbsoluteUrl("/images/empty-tap.jpg");?>"></br><span class="payment-red"><?php echo Yii::t('app','Sorry...'); ?></span> <?php echo Yii::t('app','User is not liked any products.'); ?></div>
														</div>
													</div>
												</div>
							...
							<div class="load-more-txt">'.Yii::t('app','Load more').'</div></div>', array('follower','id' =>Myclass::safe_b64encode($user->userId.'-'.rand(0,999))),
										...
										$(".load").show(); 
										 ...
										 $("#follower").append(output);   
										        ...
										        $(".no-more").html(Yii.t("app","No More Followers")); 
										        $(".load-more-cnt").hide();  
										...
										<?php }else {?>
											<div class="modal-dialog modal-dialog-width">
													<div class="col-xs-8 col-sm-12 col-md-12 col-lg-12 no-hor-padding" style="margin-bottom:100px;">
														<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
															<div class="payment-decline-status-info-txt" style="margin: 8% auto 0;"><img src="<?php echo Yii::app()->createAbsoluteUrl("/images/empty-tap.jpg");?>"></br><span class="payment-red"><?php echo Yii::t('app','Sorry...'); ?></span> <?php echo Yii::t('app','Yet no follower are here.'); ?></div>
														</div>
													</div>
												</div>
										<?php } ?>
									...
									<!--	<div class="btn-block load">
										<?php if(count($followerlist) >= 15) {
											...
											<div class="modal-dialog modal-dialog-width">
													<div class="col-xs-8 col-sm-12 col-md-12 col-lg-12 no-hor-padding" style="margin-bottom:100px;">
														<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-hor-padding">
															<div class="payment-decline-status-info-txt" style="margin: 8% auto 0;"><img src="<?php echo Yii::app()->createAbsoluteUrl("/images/empty-tap.jpg");?>"></br><span class="payment-red"><?php echo Yii::t('app','Sorry...'); ?></span> <?php echo Yii::t('app','Yet no following are here.'); ?></div>
														</div>
													</div>
												</div>

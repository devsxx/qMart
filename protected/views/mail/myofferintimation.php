			...
			<table cellpadding="0" cellspacing="0" border="0"
				...
				<tr>
					<td style="padding: 15px 0;" valign="top">
						...
						<p style='margin-bottom: 10px'><?php echo Yii::t('app','There is an offer placed in your
							profile. This email confirms that the same offer has been
							processed and recommend you to proceed with the sales of this
							product.'); ?></p>
						...
						<p style='margin-bottom: 10px'> <?php echo Yii::t('app','You have options to confirm this
							offer.'); ?></p>

					...
					<td width="100%" valign="top" align="left" bgcolor="#ffffff"style="font-family: Georgia, serif; background: #fff;">
						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; font-family: Trebuchet MS; border-bottom: 1px solid #333333; "> Hello <?php echo $name; ?>, Welcome to <?php echo $siteSettings->sitename; ?></h2>
							</td>
						</tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','To complete the registration of your new account, 
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','If clicking this link does not work, copy and paste the link directly into 
										the address bar of your browser. If you are still having problem, simply 
										contact our support team by writing to '); ?><?php echo $siteSettings->sitename; ?>
									</p>
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','Once you do, you will be able to access to the notification of activity and 
							...
							<tr>
								<td style="padding: 15px 0"  valign="top">
									<p style="color: #333333; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 14px;font-family: Arial; ">
										...
										<br />
										<b><?php echo $siteSettings->sitename.' Team'; ?>.</b>
									</p>
									<br>
								</td>
							</tr>

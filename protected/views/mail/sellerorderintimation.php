								...
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<table width="100%" class='order-details-table' style='border-spacing: 0;border-collapse: collapse;border: none;'>
										  <tr>
										    <th style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);'>Item<?php echo Yii::t('app','Regards,'); ?></th>
										    <th style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);'>Quantity<?php echo Yii::t('app','Regards,'); ?></th>
										    <th style='padding: 6px 10px;border: 1px solid rgba(0, 0, 0, 0.12);'>Size<?php echo Yii::t('app','Regards,'); ?></th>
										  </tr>
										  <tr>
									...
									<p style='margin-bottom: 10px;font-size:16px;'>
										 <?php echo Yii::t('app','Total:'); ?><b><?php echo $keyarray['mc_gross']." ".$keyarray['mc_currency']; ?></b>
									</p>
									<p style='margin-bottom: 10px'>

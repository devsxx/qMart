				...
				<tr>
					<td style="padding: 15px 0;" valign="top">
						...
						<p style='margin-bottom: 10px'>
							...
							<?php echo "Shipment Started On: ".date("d-m-Y",$tracking->shippingdate); ?>
							<br>
							<?php echo "Logistic Name: ".$tracking->couriername." &nbsp;&nbsp;&nbsp;&nbsp;Service Type: ".$tracking->courierservice; ?>
							<br>
							<?php echo "Tracking Id: ".$tracking->trackingid; ?>
							<br>
							<?php echo "Additional Notes: ".$tracking->notes; ?>
							<br>
						</p>

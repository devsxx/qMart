        ...
        <td bgcolor="#FFFFFF" height="60" align="left">
			...
			<a rel="nofollow" target="_blank" href="<?php echo Yii::app()->createAbsoluteUrl('/'); ?>">
				...
				if(!empty($siteSettings->logo)){
					echo '<img src="'.Yii::app()->createAbsoluteUrl('media/logo/'.$siteSettings->logo).'" style="width: 130px;">';
				}else{
			...
			<!-- <p style="color: #dfa575; font: normal 11px Georgia, serif; margin: 0; padding: 0; line-height: 11px;">A Perfect fancy clone script</p> -->
        </td>
      </tr>
	  <tr>

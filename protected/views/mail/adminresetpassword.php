						...
						<tr>
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									...
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','We have reseted your old password for some security reasons. 
										The new password is provided along with this email. 
										Please use the new password to login your account 
										and change your password manually for 
										security purpose.'); ?>
									</p>
									<p style='margin-bottom: 10px'>
